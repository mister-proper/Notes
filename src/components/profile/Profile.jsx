...
const Profile = () => {
    const profileValue = useSelector(state => state.profile.profileValue);
    ...
    return (
        <div className="profile">
            <div className="profile__container">
                ...
                <h2 onClick={() => setViewMenu(!viewMenu)} className="profile__name">{profileValue}</h2>
            </div>
            {viewMenu && <ProfileMenu/>}
        </div>
    )
};
